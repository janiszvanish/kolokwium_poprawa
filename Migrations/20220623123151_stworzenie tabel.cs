...
{
    public partial class stworzenietabel : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OrganizationName = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MemberNickName = table.Column<string>(type: "nvarchar(29)", maxLength: 29, nullable: true)
                },
                constraints: table =>
                {
